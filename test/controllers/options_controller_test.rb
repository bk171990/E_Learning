...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { exam_questions_id: @option.exam_questions_id, is_answer: @option.is_answer, option: @option.option } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { exam_questions_id: @option.exam_questions_id, is_answer: @option.is_answer, option: @option.option } }
